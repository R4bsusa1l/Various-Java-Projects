...
import static FilePictureDatasource.*;
...
class FilePictureDatasourceTest {
    ...
    @Test
    void checkNoHardCodedLineSeparators() {
        CodeTesterUtils.check(FilePictureDatasource.class, CodeTesterUtils::checkNoHardCodedLineSeparators);
    }
}
