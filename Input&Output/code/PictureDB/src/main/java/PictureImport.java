...
/**
 * This demo-application reads some picture data from the terminal,
...
public class PictureImport {
     ...
     * Accepts an optional locale as an argument (e.g., "en", "de"). It uses the default locale if no argument is provided.
     *
    ...
    private Picture createPicture() {
        ...
        do {
            ...
            try {
                ...
                out.printf("ERROR: Malformed URL – %s%n", e.getMessage());
            }
        } while (url == null);
