...
public interface Datasource<T extends Datarecord> {
     ...
     * If the identifier cannot be found in the data dource, an {@link RecordNotFoundException} is thrown.
     *
     ...
     * If the identifier cannot be found in the data source, an {@link RecordNotFoundException} is thrown.
     *
     * @param record to be deleted from the data source
     * @throws RecordNotFoundException if the record is not existing
     * @throws DatasourceException     if an error occurs accessing the data source
     */
     ...
     * If the record cannot be found, an {@link Optional#empty()} is returned.
